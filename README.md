# ACE-ComfyUI
a custom node for [ACE](https://github.com/ali-vilab/ACE),mixin `['Facial Editing','Controllable Generation','Render Text',
...
|--|--|--|--|--|
|`image let the man smile`|![](./doc/imgs/e33edc106953.png)|--|--|![](./doc/imgs/ComfyUI_temp_oeifd_00002_.png)|
|`"A person sits contemplatively on the ground, surrounded by falling autumn leaves. Dressed in a green sweater and dark blue pants, they rest their chin on their hand, exuding a relaxed demeanor. Their stylish checkered slip-on shoes add a touch of flair, while a black purse lies in their lap. The backdrop of muted brown enhances the warm, cozy atmosphere of the scene." , generate the photo that corresponds to the given scribble image.`|![](./doc/imgs/131ca90fd2a9.png)|--|--|![](./doc/imgs/ComfyUI_temp_oeifd_00004_.png)|
|`Put the text "C A T" at the position marked by mask in the image`|![](./doc/imgs/33e9f27c2c48.png) ![](./doc/imgs/ComfyUI_temp_tnhmz_00001_.png)|--|--|![](./doc/imgs/ComfyUI_temp_ckpiv_00001_.png)|
|`edit image based on the style of image1`|![](./doc/imgs/9e73e7eeef55.png)|![](./doc/imgs/2e02975293d6.png)|--|![](./doc/imgs/ComfyUI_temp_ajkny_00005_.png)|
|`Could the image be widened within the space designated by mask, while retaining the original?`|![](./doc/imgs/f2b22c08be3f.png)![](./doc/imgs/ComfyUI_temp_uqyzr_00002_.png)|--|--|![](./doc/imgs/ComfyUI_temp_ajkny_00007_.png)|
|`image Segmentation`|![](./doc/imgs/db3ebaa81899.png)|--|--|![](./doc/imgs/ComfyUI_temp_ajkny_00008_.png)|
|`Eliminate noise interference in image and maximize the crispness to obtain superior high-definition quality`|![](./doc/imgs/0844a686a179.png)|--|--|![](./doc/imgs/ComfyUI_temp_ajkny_00009_.png)|
|`Refashion the mask portion of image in accordance with "A yellow egg with a smiling face painted on it"`|![](./doc/imgs/632899695b26.png)![](./doc/imgs/ComfyUI_temp_llsyj_00001_.png)|--|--|![](./doc/imgs/ComfyUI_temp_ajkny_00011_.png)|
|`Discard the contents of the mask area from image`|![](./doc/imgs/1ae96d8aca00.png)![](./doc/imgs/ComfyUI_temp_llsyj_00002_.png)|--|--|![](./doc/imgs/ComfyUI_temp_ajkny_00012_.png)|
## Use case
```
[
            'Facial Editing',
